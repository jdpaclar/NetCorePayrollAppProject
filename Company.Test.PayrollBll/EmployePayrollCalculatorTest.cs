...
{
    [TestClass]
    public class EmployeePayrollCalculatorTest
    {
        [TestMethod]
        public void TestCorrectEmployeeIncomeTax()
        {
            ...
            var payCalculator = new EmployeePayrollCalculator(formulaConf.Object, null);
        ...
        public void TestSalaryNotInRangeForIncomeTax()
        {
            ...
            var payCal = new EmployeePayrollCalculator(formulaConf.Object, null);
